            ...
            <div>
                <div className="flex gap-10 h-full w-full">
                    ...
                    <div className="flex-1">
                        <div className="border-3 border-plink text-center text-base mb-2 rounded-lg p-2"> scroll down and see my favorite percussion music! i promise its rlly cool 🙏</div>
                        <Games />
                    </div>
                </div>
                <Percussion />
